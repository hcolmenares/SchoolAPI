...
namespace SchoolAPI.Business.Services
{
    public class ProfessorService : IProfessorService
    {
        ...
        public ProfessorService(IRepository<Professor> repository, IMapper mapper)
        {
            _repository = repository;
            _mapper = mapper;
        }

        public async Task<APIResponse> AddRegisterAsync(ProfessorCreatedDto entityDto)
        {
            try
            {
                if (entityDto == null)
                ...
                var entity = _mapper.Map<Professor>(entityDto);
        ...
        public async Task<APIResponse> EditRegisterAsync(ProfessorEditDto entityDto)
        {
            try
            {
                if (entityDto == null)
        ...
        public async Task<APIResponse> GetAllAsync()
        {
            try
            {
                ...
                var result = _mapper.Map<List<Professor>>(entities);
        ...
        public async Task<APIResponse> GetByIdAsync(string id)
        {
            try
            {
                ...
                var result = _mapper.Map<Professor>(entity);
                return new APIResponse { IsSuccessful = true, Result = result };
            }
            catch (Exception ex)
            {
